...
class TardyTotalTimeModel:
    ...
    def set_objective(self):
        ...
        processing = m.sum(D.Tam[a, mach] * self.x[a, mach] for a in D.A for mach in D.Ma[a])
        ...
        m.minimize(D.weight['tardy'] * tardiness + D.weight['total_time'] * (processing + movement + setup))
