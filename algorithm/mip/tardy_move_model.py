...
class TardyMoveModel:
    ...
    def __init__(self, data):
        ...
        self.w, self.x, self.t, self.q, self.y, self.C, self.z = {}, {}, {}, {}, {}, {}, {}
    ...
    def set_objective(self):
        ...
        m.minimize(D.weight['tardy'] * m.sum(D.Up[p] * self.z[p] for p in D.P) + D.weight['move'] * m.sum(D.Emn.get((mach, n), 0.0) * q for (a, mach, n), q in self.q.items()))
